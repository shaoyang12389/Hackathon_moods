...
track_feature = pd.read_csv("https://github.com/shaoyang12389/Hackathon_moods/blob/main/tracks.csv ")
moods = pd.read_csv("https://github.com/shaoyang12389/Hackathon_moods/blob/main/data_moods.csv")


#image = Image.open('C:\\Users\\91865\\Desktop\\Streamlit Demo\\data\\sal.jpg') 

image_logo = Image.open("https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/logo.png")
image_calm = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/calm.JPG')
image_chill = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/chillout.JPG')
image_energetic = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/energetic.JPG')
image_explicit = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/explicit.JPG')
image_happy = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/happy.JPG')
image_party = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/party.JPG')
image_road = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/road.JPG')
image_sad = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/sad.JPG')
image_sport = Image.open('https://github.com/shaoyang12389/Hackathon_moods/blob/main/Images/sport.JPG')

st.image(logo, width=200)

# st.markdown("<h1 style='text-align: center; color: grey;'>Verse</h1>", unsafe_allow_html=True)

# st.markdown("<h2 style='text-align: center; color: black;'>Vibe your mood </h2>", unsafe_allow_html=True)
#Titre et centrage
st.subheader("Bienvenue dans un univers de recommandations musicales \U0001F3B5")

tab1, tab2 = st.tabs(["Sur le pouce", "MoodVerse"])
...
with tab1:
    liste_humeur = ['sport', 'chill', 'eXplicit', 'party', 'road']
    choix_humeur = st.selectbox('Que voulez-vous faire ?',(liste_humeur), index=0)
...
# Définir des variables
    ...
    choix_emotion = st.selectbox('Choisis ta vibe',(liste_emotion), index=0)
    if st.button("Obtenir des recommandations"):
        result = sentiment_song(choix_emotion)
        if result is not None:
            #st.subheader("\U0001F9D0")
        ...
        if video_url:
            #st.subheader(f"Vidéo pour la chanson '{title}':")
            st.video(video_url)
        else:
